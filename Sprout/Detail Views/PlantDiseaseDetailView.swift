...
#Preview {
    PlantDiseaseDetailView(disease: PlantDisease(id: 1, commonName: "Fairy ring", scientificName: "Agrocybe", otherName: nil, family: nil, description:
                                                    [
