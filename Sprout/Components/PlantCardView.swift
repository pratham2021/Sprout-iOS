...
struct PlantCardView: View {
    ...
    @State var showPlantCardDetail = false
    ...
    var body: some View {
        ...
        .onTapGesture {
            ...
            showPlantCardDetail = true
        }
        .fullScreenCover(isPresented: $showPlantCardDetail) {
            PlantCardDetailView(plant: plant, showDetail: $showPlantCardDetail)
        }
